...
@RequestMapping(method = RequestMethod.GET, value="/cliente/movimiento/cuenta/{numcuenta}/{fecha}/{tipotx}/{valor}")
	...
	public MovimientoReply movExistenteCuenta(@PathVariable("numcuenta") String numcuenta, @PathVariable("fecha") String fecha, @PathVariable("tipotx") String tipotx, @PathVariable("valor") Double valor) {		
	    ...
	    ClienteCuenta c2 = new ClienteCuenta("220033110521","250219", "2", 120.33);
	    ClienteCuenta c3 = new ClienteCuenta("220033110522","250219", "1", 255.15);
	    ClienteCuenta c4 = new ClienteCuenta("220033110523","250219", "2", 15.00);
	    ClienteCuenta c5 = new ClienteCuenta("220033110524","250219", "3", 55.90);
	    ClienteCuenta c6 = new ClienteCuenta("220033110525","250219", "2", 100.00);
	    ClienteCuenta c7 = new ClienteCuenta("220033110526","250219", "1", 205.15);
	    ClienteCuenta c8 = new ClienteCuenta("220033110527","250219", "2", 15.00);
